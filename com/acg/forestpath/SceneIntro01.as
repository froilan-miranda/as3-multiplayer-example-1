...
public class SceneIntro01 extends Sprite
{
	...
	private function initScene(e:Event):void
	{
		...
		videoIntro = new VideoPlayer(ForestPath.STAGE_WIDTH, ForestPath.STAGE_HEIGHT, "assets/video/Intro01.flv", false);
		videoIntro.addEventListener(CustomEvent.CUE_POINT, onCuePoint);
	...
	public function msgProcess(msg:String):void
	{
		...
		switch(msgArray[0]){
			case "GO_INTRO":
				videoIntro.play();
				Audio.playWindSound(7);
				break;
			case "GO_LEVEL":
				SceneLevel01.timeLimit = msgArray[1];
				EOS();
				break;
			case "RESET":
				this.onReset();
	...
	{
		trace("here is eos");
		sceneTween = new GTween(this, 1, {alpha:0.0});
