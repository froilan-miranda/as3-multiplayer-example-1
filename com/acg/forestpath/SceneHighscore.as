...
public class SceneHighscore extends Sprite
{
	...
	public function SceneHighscore():void
	{
		this.alpha = 0.0;
		if(stage)
			initScene(null);
	...
	private function loadBG():void
	{
		...
		if (ssGlobals.ssStartDir == null) {
			...
			imageUrl = new URLRequest(ssGlobals.ssStartDir + "\\" + "assets/images/bg/bg_TopScores.png");			
		}
		bgLoader = new Loader();
	...
	private function showScores(e:Event):void
	{
		...
		var dailyHighScores:Array = PlayerInfoManager.dailyHighScore;

		for(var i:uint = 0; i < dailyHighScores.length; i++) {

			var highScoreNameScore:Array = dailyHighScores[i].split(",");
			...
			txtPlayer.text = highScoreNameScore[0];
			txtPlayer.x = 882;
			...
			var txtComma = String(highScoreNameScore[1]);
